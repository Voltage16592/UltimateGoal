...
@TeleOp(name="TOpMode_HeavyArm", group="Iterative Opmode")
//@Disabled
public class TOpMode_HeavyArm
        extends OpMode
{
    // Declare OpMode members.
    private ElapsedTime runtime = new ElapsedTime();
    private SubSys_TestBot testBot = new SubSys_TestBot();
    ...
    public void loop() {
        ...
        testBot.moveHeavyArm(gamepad1);
        telemetry.addData("cc_limitswitch", testBot.cc_limitswitch.getState());
        telemetry.addData("cw_limitswitch", testBot.cw_limitswitch.getState());
        telemetry.update();
    }
