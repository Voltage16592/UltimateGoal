...
@Autonomous(name="AOpMode_ElephFoundationRED", group="Linear Opmode")
//@Disabled
public class AOpMode_ElephFoundationRED extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        inches = 3;
        encoderDrive(1, inches, -inches, inches, -inches, 4);//TURN CLOCKWISE
        inches = 45;
        encoderDrive(1, -inches, -inches, -inches, -inches, 4);//Move Back
        elephant.eTail.setPosition(0.95);//put Foundation grabber down
        sleep(1000);
        inches = 50;
        encoderDrive(1, inches, inches, inches, inches, 4);//Move Forward & bring foundation into building site
        elephant.eTail.setPosition(0.5);//Release Tail
        sleep(1000);
        inches = 50;
        encoderDrive(1, inches, inches, inches, inches, 4);//Move Forward + line up against wall
        inches = 30;
        //Move left a little
        inches = 5;
        //turn COUNTERCLOCKWISE
        inches = 35;
        encoderDrive(1, inches, -inches, -inches, inches, 4);//Move Left + Park under bridge
        inches = 5;
        encoderDrive(1, inches, inches, inches, inches, 2);//Move Forward to get on wall
